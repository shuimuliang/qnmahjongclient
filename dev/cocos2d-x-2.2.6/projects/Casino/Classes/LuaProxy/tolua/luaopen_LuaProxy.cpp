...
//		tolua_constant(l, "GL_TEXTURE_WIDTH", GL_TEXTURE_WIDTH);
		...
		tolua_endmodule(l);
		tolua_constant(l, "kLuaEventKeyBack", (int)LuaEventHandler::KeyBack);
		tolua_constant(l, "kLuaEventKeyMenu", (int)LuaEventHandler::KeyMenu);
		tolua_constant(l, "kLuaEventAppEnterBackground", (int)LuaEventHandler::AppEnterBackground);
		tolua_constant(l, "kLuaEventAppEnterForeground", (int)LuaEventHandler::AppEnterForeground);
