...
/* method: getOwnerOutletTypes of class  CCBReader */
#ifndef TOLUA_DISABLE_tolua_Cocos2d_CCBReader_getOwnerOutletTypes00
static int tolua_Cocos2d_CCBReader_getOwnerOutletTypes00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
    if (
...
#endif
    {
        CCBReader* self = (CCBReader*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
        if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getOwnerOutletTypes'", NULL);
#endif
        {
            CCArray* tolua_ret = (CCArray*)  self->getOwnerOutletTypes();
            int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
            int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
            toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCArray");
        }
...
#ifndef TOLUA_RELEASE
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'getOwnerOutletTypes'.",&tolua_err);
    return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: runAnimationsForSequenceNamed of class  CCBAnimationManager */
#ifndef TOLUA_DISABLE_tolua_Cocos2d_CCBAnimationManager_setScriptHandler00
static int tolua_Cocos2d_CCBAnimationManager_setScriptHandler00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
...
/* method: runAnimationsForSequenceNamed of class  CCBAnimationManager */
#ifndef TOLUA_DISABLE_tolua_Cocos2d_CCBAnimationManager_stopAnimations00
static int tolua_Cocos2d_CCBAnimationManager_stopAnimations00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
...
#endif
	{
		CCBAnimationManager* self = (CCBAnimationManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
		if (!self) tolua_error(tolua_S,"invalid 'self' in function 'stopAnimations'", NULL);
#endif
		{
			self->stopAnimations();
		}
...
#ifndef TOLUA_RELEASE
tolua_lerror:
	tolua_error(tolua_S,"#ferror in function 'stopAnimations'.",&tolua_err);
	return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_extensions_ccb_open(lua_State* tolua_S){
    ...
    tolua_beginmodule(tolua_S,NULL);
     ...
     tolua_beginmodule(tolua_S,"CCBReader");
      ...
      tolua_function(tolua_S,"getOwnerOutletTypes",tolua_Cocos2d_CCBReader_getOwnerOutletTypes00);
     ...
     tolua_beginmodule(tolua_S,"CCBAnimationManager");
	  ...
	  tolua_function(tolua_S, "setScriptHandler", tolua_Cocos2d_CCBAnimationManager_setScriptHandler00);
	  tolua_function(tolua_S, "stopAnimations", tolua_Cocos2d_CCBAnimationManager_stopAnimations00);
