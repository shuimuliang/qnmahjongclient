...
ccLanguageType CCApplication::getCurrentLanguage()
{
    ...
    else if(0 == strcmp("hk",pLanguageName))
    {
        ret = kLanguageChineseTraditional;
    }
    else if(0 == strcmp("tw",pLanguageName))
    {
        ret = kLanguageChineseTraditionalTaiwan;
    }
    else if(0 == strcmp("tr",pLanguageName))
    {
        ret = kLanguageThailand;
    }
    else if(0 == strcmp("my",pLanguageName))
    {
        ret = kLanguageMalaysia;
    }
