	    ...
	    case kCCBPropTypeFloatXY:
	      {
            ...
            case kCCBPropTypeBlendmode: 
            {
                ...
                if(setProp) 
                {
                    ...
                    /*************** warning  *******************/
                    /** have problem when CCRenderTexture doblur  */
                    /**             closed by liulihua           **/
...
//     ccbReader->mOwnerCallbackNodes->retain();
    ...
    if (ccbReader->isJSControlled() && pCCBReader->isJSControlled() && NULL == ccbReader->mOwner)
    {
        ...
        CCArray *ownerOutletTypes = ccbReader->getOwnerOutletTypes();
            ...
            NULL != ownerOutletNodes && ownerOutletNodes->count() > 0)
        {
            ...
            for (int i = 0 ; i < nCount; i++) {
                ...
                pCCBReader->addOwnerOutletType(static_cast<CCString*>(ownerOutletTypes->objectAtIndex(i))->getCString());
            }
        }
    }
    return ccbFileNode;
